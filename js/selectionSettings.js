...
(function () {
  ...
  var selectionSettings = function () {
    const _self = this;
    $(`${this.containerSelector} .main-panel`).append(`<div class="toolpanel" id="select-panel"><div class="content"><p class="title">Редактирование объекта</p></div></div>`);
        ...
        <div class="text-section">
          ...
          <div class="family">
            ...
            <select id="font-family">
              ...
              <option value="'Great Vibes', cursive">Amatic SC</option>
          ...
          <div class="sizes">
            <div class="input-container"><label>Размер шрифта</label>
              ...
              <input type="number" min="1" value="200" step="10" id="fontSize">
              <button class="increase">+</button>
              </div>
            </div>
            <div class="input-container"><label>Высота строки</label>
              <div class="custom-number-input">
              <button class="decrease">-</button>
            ...
            <div class="input-container"><label>Межбуквенное расстояние</label>
              <div class="custom-number-input">
              <button class="decrease">-</button>
    ...
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <div class="border-section">
          <h4>Обводка выбранной фигуры</h4>
          <div class="input-container"><label>Толщина обводки фигуры</label>
            <div class="custom-number-input">
            <button class="decrease">-</button>
            <input type="number" min="1" value="50" step="10" id="input-border-width">
            <button class="increase">+</button>
            </div>
          </div>
          <div class="input-container"><label>Края фигуры</label><select id="input-border-style">${BorderStyleList.map(item => `<option value='${JSON.stringify(item.value)}'>${item.label}</option>`)}</select></div>
          <div class="input-container"><label>Углы фигуры</label><select id="input-corner-type"><option value="miter" selected>Квадратные</option><option value="round">Закругленные</option></select></div>
          <div class="input-container"><label>Цвет обводки фигуры</label><input id="color-picker" value="black"></div>
          <hr>
        </div>
      `);
    ...
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <div class="fill-section">
          ...
          <div class="tabs">
            <div class="tab-label" data-value="color-fill">Сплошная заливка</div>
            <div class="tab-label" data-value="gradient-fill">Градиент</div>
          </div>
            ...
            <div class="gradient-orientation-container">
              <div class="input-container">
                ...
                <select id="select-orientation">
                  <option value="linear">Линейниый</option>
    ...
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <div class="effect-section">
          <h4>Эффекты</h4>
          <div class="input-container"><label>Непрозрачность</label><input id="opacity" type="range" min="0" max="1" value="1" step="0.01"></div>
          <div class="input-container"><label>Размытие</label><input class="effect" id="blur" type="range" min="0" max="100" value="50"></div>
          <div class="input-container"><label>Яркость</label><input class="effect" id="brightness" type="range" min="0" max="100" value="50"></div>
          <div class="input-container"><label>Насыщенность</label><input class="effect" id="saturation" type="range" min="0" max="100" value="50"></div>
          <h5>Коррекция гаммы</h5>
          <div class="input-container"><label>Красный</label><input class="effect" id="gamma.r" type="range" min="0" max="100" value="50"></div>
          <div class="input-container"><label>Зелёный</label><input class="effect" id="gamma.g" type="range" min="0" max="100" value="50"></div>
          <div class="input-container"><label>Синий</label><input class="effect" id="gamma.b" type="range" min="0" max="100" value="50"></div>
          <hr>
        </div>
      `);
