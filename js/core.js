    ...
    this.setActiveTool = (id) => {
      ...
      switch (id) {
        ...
        case 'path':
          ...
          this.updateTip('<b>Подсказка:</b> клик чтобы добавить узел, нажать и тянуть для создания кривых. Коик вне холста или Esc чтобы завершить изменения кривой');
          break;
        case 'textbox':
        ...
        case 'upload':
          ...
          break;
        default:
          this.updateTip('<b>Подсказка:</b> зажмите Shift когда рисуете прямую, чтобы расположить линию с наклоном шагом 15°');
          break;
      }
    }
