...
(function () {
  ...
  var canvasSettings = function () {
    const _self = this;
    $(`${this.containerSelector} .main-panel`).append(`<div class="toolpanel" id="background-panel"><div class="content"><p class="title">Настройки фона</p></div></div>`);
    ...
    (() => {
      ...
      <div class="canvas-size-setting">
        ...
        <div class="input-container">
          ...
          <input type="number" min="100" id="input-width" value="1200"/>
        ...
        <div class="input-container">
          ...
          <div class="custom-number-input">
          <button class="decrease">-</button>
          <input type="number" min="100" id="input-height" value="533"/>
          <button class="increase">+</button>
          </div>
        </div>
      </div>
