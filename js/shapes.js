...
(function () {
  ...
  var shapes = function () {
    ...
    $(`${this.containerSelector} .main-panel`).append(`<div class="toolpanel" id="shapes-panel"><div class="content"><p class="title">Фигуры</p></div></div>`);
    ...
    $(`${this.containerSelector} .toolpanel#shapes-panel .content .button`).click(function () {
      ...
      try {
        ...
        console.error("Невозможно добавить фигуру");
      }
    })
  }
